...
x = BatchNormalization()(x)
x = ReLU()(x)
x = convolution_block(x, filters=16, strides=1)
x = convolution_block(x, filters=32, strides=2)
x = convolution_block(x, filters=32, strides=1)
x = convolution_block(x, filters=64, strides=2)
