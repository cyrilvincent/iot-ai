...
np.save("data/har/raw/xtrain1000.npy", xtrain[:1000])  # Pour la calibration INT8
...
batch_size = 128 # 1.28s
model.fit(xtrain, ytrain, epochs=10, batch_size=batch_size, validation_data=(xtest, ytest), shuffle=True)
