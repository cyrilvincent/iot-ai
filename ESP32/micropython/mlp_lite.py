...
if __name__ == '__main__':
    ...
    # MLP
    ol = Layer("OL")
    ol.perceptrons.append(Perceptron("O0", [0.01280988, 0.48250077, -0.87647631, 0.63974548, 0.24925486, 0.35656178, -0.43275108, -0.77644924], sigmoid_fn))
